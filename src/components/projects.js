    ...
    constructor(props) {
        ...
        toggleCategories() {
            if(this.state.activeTab === 0) {
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                        <CardTitle style={{color: '#fff', height: '176px', background: 'URL(data:image/jpeg;base64,) center / cover' }}>
                            Github repos
                                ...
                                <CardText>Link to Github account</CardText>
                                    <CardActions border>
                                        <Button href='https://github.com/JohnnyJii' target='_blank'>Github</Button>
                                    </CardActions>   
                    ...
                    <div className="projects-insta">
                        <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                            <CardTitle className="instaCard" style={{color: '#fff', height: '176px'}}>
                                ...
                                <CardText>This is where you can stalk me...</CardText>
                                    <CardActions border>
                                        <Button href='https://www.instagram.com/johnnyjii' target='_blank'>Instagram</Button>
                                    </CardActions>
                                    <CardMenu style={{color: '#fff'}}>
                                        <IconButton name="share" />
                                    </CardMenu>
                ...
                return (
                    <div>
                        <h1>Tulossa pikapuoliin...</h1>
                            <div className="projects-blank">
                            <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                                <CardTitle className="blankCard" style={{color: '#fff', height: '176px'}}>
                                    
                                </CardTitle>
                                    <CardText>Lortsu ipsu</CardText>
                                        <CardActions border>
        ...
        return (
            <div className="category-tabs">
                <Tabs activeTab={this.state.activeTab} onChange={(tabId) => this.setState({activeTab: tabId})} ripple>
                    ...
                    <Tab>Instagram</Tab>
                    <Tab>Tyhjä</Tab>
                    <Tab>Front projekit</Tab>
                    <Tab>backki projekti</Tab>
                </Tabs>    
